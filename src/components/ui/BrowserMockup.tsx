    ...
    <div className={`w-full rounded-lg overflow-hidden shadow-xl border border-gray-200 ${className}`}>
      ...
      <div className="bg-gray-100 border-b border-gray-200 flex flex-col">
        ...
        <div className="flex items-center px-2 pt-1.5">
          ...
          <div className="flex items-center">
            <div className="flex items-center bg-white border-t border-l border-r border-gray-200 rounded-t-md py-1.5 px-4 text-sm font-medium text-gray-800">
              <div className="w-4 h-4 mr-2 rounded-full bg-[#D4AF37]"></div>
              ALU Student Assistant
            </div>
            <div className="flex items-center bg-gray-100 border-t border-l border-r border-gray-200/50 rounded-t-md py-1.5 px-4 text-sm font-medium text-[#1A1A1A]/50">
              ALU Portal
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center px-4 py-1.5 pb-2">
          <div className="flex items-center gap-2 mr-3 text-[#1A1A1A]/50">
          ...
          <div className="flex-1 bg-white border border-gray-200 rounded-full py-1 px-3 flex items-center text-sm text-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-lock mr-2 text-[#1A1A1A]/60"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            alu-assistant.education
          </div>
          <div className="ml-3 text-[#1A1A1A]/50">
        ...
        <div className="flex h-full">
          ...
          <div className="w-48 bg-gray-50 border-r border-gray-100 p-3 hidden md:block">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center">
                <div className="w-6 h-6 rounded-md bg-[#D4AF37] flex items-center justify-center text-[#1A1A1A] font-bold text-xs">A</div>
                <span className="ml-2 font-medium text-gray-800">ALU Assistant</span>
              </div>
            </div>
            <div className="space-y-1">
              <div className="px-2 py-1.5 bg-[#D4AF37]/10 rounded text-[#D4AF37] text-sm font-medium">Dashboard</div>
            ...
            <div className="h-full flex flex-col">
              <div className="flex-1 overflow-hidden p-3">
                ...
                <div className="flex mb-4">
                  <div className="w-8 h-8 rounded-full bg-[#D4AF37] flex items-center justify-center text-[#1A1A1A] font-bold text-xs">A</div>
                ...
                <div className="flex justify-end mb-4">
                  <div className="bg-[#D4AF37]/10 rounded-lg p-3 max-w-[80%] mr-3">
              ...
              <div className="border-t border-gray-100 p-3">
                <div className="flex items-center bg-gray-50 rounded-lg border border-gray-200 px-3 py-2">
                  ...
                  <button className="ml-2 w-8 h-8 rounded-full bg-[#D4AF37] flex items-center justify-center text-[#1A1A1A]">
